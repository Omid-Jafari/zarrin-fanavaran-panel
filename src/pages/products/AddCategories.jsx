...
import { addCategory } from "../../api/ApiClient";
...
function AddCategories() {
  ...
  const addCategoryMutataion = useMutation((data) => addCategory(data), {
    onSuccess: (res) => {
      navigate(-1);
      formik.resetForm();
    },
        ...
        <form onSubmit={formik.handleSubmit}>
          <div className="w-full bg-blue-lightt rounded-lg pt-14 px-4 pb-4 mt-4 flex flex-col gap-5 ">
            ...
            <div className="w-full flex flex-row justify-start items-center gap-6 ">
              ...
              >
                <div className="bg-primary hover:bg-blacklead transition-colors duration-500 flex w-[90px] h-[90px] rounded-lg z-30 cursor-pointer flex-col justify-center items-center">
                  <>
                    <svg
                      width="24"
                      height="24"
