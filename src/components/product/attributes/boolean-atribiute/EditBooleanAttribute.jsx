...
function EditBooleanAttribute({}, ref) {
  ...
  const formik = useFormik({
    ...
    onSubmit: (data) => {
      ...
      console.log("sdvdsvscvsdv", attributes);
    ...
    validate: (r) => {
      console.log("dvsdsdvsdvsdvsdv", r);
    },
  });
  ...
  useEffect(() => {
    ...
    fromEdit() && formik.setFieldValue("value", attrData?.value);
    formik.setFieldValue("attrData", attrData?.attrData);
    formik.setFieldValue("other_option_ids", attrData?.attrData?.options);
...
export default React.forwardRef(EditBooleanAttribute);
