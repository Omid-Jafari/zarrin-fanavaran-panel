...
function SingleOptionAttributeCardItem({ attr, index }) {
  ...
  console.log("Sdergregergvsdvsdv", attr);
  ...
  // useEffect(() => {
  // attr.value=attr?.options[0].name_fa
  // }, [])

  return (
    <div className="w-full bg-white flex flex-col my-2 rounded-[4px] p-3">
      <EditSingleOptionAttributeModal ref={editAttrModalRef} />
      {/* title */}
      ...
      <div className="mt-3 flex-col ">
        ...
        <div className="w-full bg-[#DBEEF6] flex px-2 flex-row justify-between mt-2 rounded-lg">
          <p className="font-Kalameh text-black items-center  text-[14px] flex py-3  gap-2 font-[500] ">
            {fromEdit() && attr?.options != undefined
              ? attr?.options[0].name_fa
              : attr?.value}
          </p>
        </div>
      </div>
      ...
      <div className="mt-3 flex-col ">
        ...
        <div className="w-full bg-[#DBEEF6] flex px-2 flex-row justify-between items-start  mt-2  rounded-lg">
          <p className="font-Kalameh text-black items-center  text-[14px] flex py-3  gap-2 font-[500]  mt-4">
            {attr?.content}
          </p>
        </div>
...
export default SingleOptionAttributeCardItem;
