      ...
      >
        ...
        <div className="fixed inset-0 z-10 overflow-y-auto ">
          <div className="flex min-h-full items-end justify-center p-4 sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform rounded-[8px] w-3/5  bg-white shadow-xl transition-all sm:my-8">
                ...
                <div className="w-full flex flex-col items-start gap-4 p-4">
                  {/* <div className="flex w-full items-center gap-3">
                    <CustomRadioBtn
                      clickFunc={() => {
                        setAllowRelated(!allowRelated);
                      }}
                      checkCondition={allowRelated}
                    />
                    <p className="font-medium font-KalamehMed">
                      نمایش مقالات مرتبط برای این مقاله
                    </p>
                  </div> */}
                  ...
                  <div className="w-full rounded-lg bg-blue-lightt flex flex-col p-4 gap-2 ">
                    {formik.values.relative_ids?.map((selectedBlogs) => (
                        ...
                        <svg
                          ...
                          onClick={() =>
                            formik.setFieldValue(
                              "relative_ids",
                              formik.values.relative_ids?.filter(
                        ...
                        <div className="absolute z-10 w-full left-0 top-12 flex flex-col max-h-36 bg-white rounded-[6px] border overflow-y-auto">
                          {blogsFilterDataMutation?.isLoading ? (
                            ...
                            blogsData?.data?.map((blog) => {
                              const check =
                                formik.values.relative_ids.indexOf(blog);
                              if (check === -1) {
                                return (
                                  <div
                                    ...
                                    onClick={() => {
                                      if (check === -1) {
                                        formik.setFieldValue("relative_ids", [
                                          ...formik.values.relative_ids,
                                          blog,
                                        ]);
                                      } else return;
                                    }}
...
export default RelatedBlogsModal;
