...
function SelectBoxSettingItem({ settingItem }) {
  ...
  return (
    <div className="w-2/6 flex flex-row gap-4 items-center">
      <div className="w-full flex flex-row justify-center items-center px-5 gap-[18px]">
        <select
        ...
        >
          {settingItem?.properties?.options &&
            Object.entries(settingItem?.properties?.options)?.map((op) => (
...
export default SelectBoxSettingItem;
