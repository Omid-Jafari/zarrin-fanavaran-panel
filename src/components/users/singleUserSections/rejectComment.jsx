...
import { rejectComment } from "../../../api/ApiClient";
import { useMutation } from "@tanstack/react-query";
import Loading from "../../elements/loading";

const RejectComment = (props, ref) => {
  ...
  const rejectCommentMutate = useMutation((data) => rejectComment(id, data), {
    onSuccess: () => {
  ...
  const rejectFormik = useFormik({
    ...
    onSubmit: (data) => {
      formik.handleSubmit();
      rejectCommentMutate.mutate(data);
    },
  });
  return (
...
export default React.forwardRef(RejectComment);
