...
import { rejectAnswer, rejectQuestion } from "../../../api/ApiClient";
import Loading from "../../elements/loading";

const AnswerRejectModal = (props, ref) => {
  ...
  const rejectQuestionMutate = useMutation((data) => rejectAnswer(id, data), {
    onSuccess: () => {
...
export default React.forwardRef(AnswerRejectModal);
